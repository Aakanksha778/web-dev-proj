    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navMenu">
        <ul class="navbar-nav align-items-center centsora-nav-list">
          ...
          <li class="nav-item"><router-link class="nav-link centsora-nav-link" to="/insights">Insights</router-link></li>
          <li class="nav-item"><router-link class="nav-link centsora-nav-link" to="/settings">Settings</router-link></li>
          <li class="nav-item ms-lg-3 mt-3 mt-lg-0">
            <router-link class="btn btn-primary nav-cta-btn" to="/login">
              Sign In
            </router-link>
          </li>
        </ul>
